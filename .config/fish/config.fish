if status is-interactive
    ...
    fish_add_path --global ~/.claude/local ~/go/bin ~/.cargo/bin ~/.local/bin ~/.bun/bin ~/.npm-global/bin /opt/homebrew/bin /opt/homebrew/opt/make/libexec/gnubin /opt/homebrew/opt/postgresql@17/bin

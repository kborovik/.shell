...
complete -c bun -l config -d "Specify config file" -r -a "(__fish_complete_path)"
...
complete -c bun -n "__fish_seen_subcommand_from add" -s d -l development -d "Add to devDependencies"
...
complete -c bun -n "__fish_seen_subcommand_from add" -s E -l exact -d "Add exact version"
...
complete -c bun -n "__fish_seen_subcommand_from remove" -s g -l global -d "Remove from global packages"
...
complete -c bun -n "__fish_seen_subcommand_from test" -s u -l update-snapshots -d "Update snapshots"

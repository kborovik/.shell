...
call s:hi("DiffAdd", "NONE", s:base, s:teal, "NONE", "NONE")
call s:hi("DiffChange", "NONE", s:base, s:rosewater, "NONE", "NONE")
call s:hi("DiffDelete", "NONE", s:base, s:maroon, "NONE", "NONE")
call s:hi("DiffText", "NONE", s:base, s:lavender, "NONE", "NONE")
